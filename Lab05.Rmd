...
```{r report}
# The mean of the three minimum distances
mean_closestdist <- mean(dn_lq_ak_mindist$closest) 
#The standard deviation of all three minimum distances
...
```
With the help of Chatgpt, I am able to add the purple lines that demostrate the minimum distances between Denny's and La Quinta hotels, yay!
